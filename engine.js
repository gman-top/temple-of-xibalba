...
const PAY_TABLE = [
  [2.13, 3.19, 5.32,  9.58, 15.97, 31.93,  53.22,  95.80],
  [1.33, 2.13, 3.73,  6.39, 10.64, 21.29,  37.25,  63.86],
  [0.80, 1.33, 2.40,  4.26,  7.45, 14.90,  25.55,  42.58],
  [0.43, 0.64, 1.17,  2.13,  3.73,  7.45,  12.77,  21.29],
  [0.21, 0.32, 0.59,  1.06,  1.86,  3.73,   6.39,  10.64],
  [0.11, 0.16, 0.27,  0.43,  0.74,  1.49,   2.66,   4.52],
  [0.05, 0.08, 0.13,  0.21,  0.37,  0.74,   1.33,   2.40],
  [0.03, 0.05, 0.09,  0.16,  0.27,  0.53,   0.96,   1.60],
  [0.02, 0.03, 0.05,  0.11,  0.16,  0.32,   0.53,   0.96],
];
